...
venue: "R for Reproducible Scientific Analysis<br><br>Griffith University <br> Virtual Campus (hosted on Zoom) "        # brief name of host site without address (e.g., "Euphoric State University")
...
latitude: "-27.960345"     # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "153.378868"    # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "15th to 18th June 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2020-06-18        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
...
helper: ["McKenna Buckley", "Jacob Dore-Porret"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["eresearch-support@griffith.edu.au"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://docs.google.com/document/d/1CdPt6_ss0KXLHWTiego9cfVGQBl1YCnjOAz31Lh-5rg/edit?usp=sharing # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
